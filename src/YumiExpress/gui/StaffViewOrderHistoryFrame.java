 ...
 * @author dell
 */
public class StaffViewOrderHistoryFrame extends javax.swing.JFrame {

    /**
     * Creates new form StaffViewOrderHistoryFrame
     */
     private List<OrderPojo> orderList;
    private DefaultTableModel model;
    public StaffViewOrderHistoryFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnOrder.setBackground(new java.awt.Color(255, 255, 102));
        ...
        jLabel5.setText("View Orders History ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StaffViewOrderHistoryFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
